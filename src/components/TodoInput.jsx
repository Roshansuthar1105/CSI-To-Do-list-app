export default function TodoInput({ task, setTask, addTask }) {
    return (
      <div className="flex gap-3 mb-6">
        ...
        <button
          onClick={addTask}
          className="bg-gradient-to-r from-cyan-500 to-purple-600 px-6 py-1 rounded-xl text-white font-semibold hover:from-cyan-600 hover:to-purple-700 transition"
        >
          Add
        </button>
      </div>
